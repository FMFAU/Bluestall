...
class UninstallerApp:
    def __init__(self):
        ...
        if os.path.exists(self.logo_path):
            try:
                pil_logo = Image.open(self.logo_path).resize((96, 96))  # Larger logo
        ...
        # Progress bar
        self.loading_progress_bar = ctk.CTkProgressBar(self.loading_frame, width=400, height=20)  # Larger progress bar
    ...
    def setup_batch_uninstall_tab(self):
        ...
        # Create a scrollable frame for batch selection
        ...
        # Button to uninstall selected apps
    ...
    def setup_uninstalled_files_tab(self):
        ...
        # Create a scrollable frame for uninstalled apps
    ...
    def update_uninstalled_apps_list(self):
        ...
        # Create new widgets for each uninstalled app
    ...
    def load_installed_apps(self):
        ...
        # Now build the main UI on the main thread
    ...
    def update_batch_apps_list(self):
        ...
        # Create new checkboxes for each app
        ...
        if app.get("install_location") and os.path.exists(app["install_location"]):
            for file in os.listdir(app["install_location"]):
                if file.lower().endswith(".exe"):
                    ...
                    break
        # If not found, fallback to a generic icon
        icon_path = os.path.join("Assets", "app_placeholder.png")
        if exe_path and os.path.exists(exe_path):
            # Try to extract icon (not implemented here, placeholder only)
            # You can use pywin32 or pyiwn32 to extract icons in a real implementation
            pass
    ...
    def update_apps_list(self):
        ...
        # Create new widgets for each app
        for app in self.apps:
    ...
    def _perform_deep_scan(self, app):
        ...
        # Scan common program files locations
        program_files_paths = [
        ...
        # Display leftovers in a message box
        if leftovers:
    ...
    def uninstall_app(self, app):
        ...
        if messagebox.askyesno("Confirm Uninstall", f"Are you sure you want to uninstall {app['name']}?"):
            ...
            # Calculate storage used before uninstalling
            storage_used = self.calculate_storage_used(app)
    ...
    def _perform_uninstall(self, app, storage_used):
        ...
        try:
            ...
            # Save uninstalled apps data to JSON
    ...
    def _cleanup_leftovers(self, app):
        ...
        try:
            ...
            # Clean up common program files locations
            program_files_paths = [
                os.environ.get('ProgramFiles', 'C:\\Program Files'),
                os.environ.get('ProgramFiles(x86)', 'C:\\Program Files (x86)'),
                os.environ.get('LOCALAPPDATA', 'C:\\Users\\%USERNAME%\\AppData\\Local'),
